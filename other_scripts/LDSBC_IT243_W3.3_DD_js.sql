...
-----   ----------   -----------   -------------------------------------------------------------------------------
1.0     01/29/2020   JSTEADMAN		1. Built this table for LDS BC IT243
RUNTIME: 
Approx. 0 sec
NOTES:
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Account branch address latitude.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'acct_branch_add_lat';
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Account branch address longitude.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'acct_branch_add_lon';
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Account branch address type.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'acct_branch_add_type';
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Account primery ID.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'acct_id';
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Account secondary ID.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'acct_id2';
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Account tertiary ID.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'acct_id3';
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Date stamp.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'as_of_date';
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'customet address ID.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'cust_add_id';
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Customer address address type.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'cust_add_type';
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Customer primary ID.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'cust_id';
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Customer seconday ID.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'cust_id2';
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'First name of customer.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p1' ,@level2type=N'COLUMN' ,@level2name=N'first_name';
...
-- Columns
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Account ID.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p2' ,@level2type=N'COLUMN' ,@level2name=N'acct_id';
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Branch ID.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p2' ,@level2type=N'COLUMN' ,@level2name=N'branch_id';
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Current c ustomer required index.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p2' ,@level2type=N'COLUMN' ,@level2name=N'cur_cust_req_ind';
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Transaction type description.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p2' ,@level2type=N'COLUMN' ,@level2name=N'tran_type_desc';
EXEC sys.sp_addextendedproperty @name=N'MS_Description' ,@value=N'Transaction type ID.' ,@level0type=N'SCHEMA' ,@level0name='dbo' ,@level1type=N'TABLE' ,@level1name=N'stg_p2' ,@level2type=N'COLUMN' ,@level2name=N'tran_type_id';
